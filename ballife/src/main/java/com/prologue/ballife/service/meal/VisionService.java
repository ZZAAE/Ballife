...
public class VisionService {
    ...
    public List<RecognizedFood> analyze(String imageDataUrl) {
        String userPrompt =
                "사진에 보이는 **가장 핵심이 되는 음식(요리) 하나만** 식별해라. 한식·양식·중식·일식·분식·간식 모두 가능. " +
                "규칙:\n" +
                "1) **반드시 foods 배열에 1개 항목만 반환**한다. 사진에 여러 음식이 보여도 가장 중심이 되는 메인 요리 1개만 선택.\n" +
                "2) 재료가 아니라 '요리 이름'으로 답해라.\n" +
                ...
                "name=요리명(한국어), grams=항상 100. foods 배열 길이는 항상 0 또는 1.";
