...
export default function MedicationPage() {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col xl:flex-row pt-[70px]">
      ...
      <button className="w-full h-[45px] bg-[#1B1F2A] text-white rounded-xl text-[14px] font-bold mb-8 hover:bg-[#2A2F3F] transition-colors"
