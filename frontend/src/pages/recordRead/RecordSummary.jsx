    ...
    items: [
      {
        name: "그릭 요거트와 블루베리",
        kcal: 245,
        macros: { carb: 18, protein: 12, fat: 8, sugar: 4, chol: 5 },
      },
      {
        name: "아몬드 한 줌",
        kcal: 160,
        macros: { carb: 6, protein: 6, fat: 14, sugar: 1, chol: 0 },
      },
    ],
    total: 405,
    totalMacros: { carb: 24, protein: 18, fat: 22, sugar: 5, chol: 5 },
  },
  {
    time: "12:45 PM",
    label: "점심",
    ...
    items: [
      {
        name: "연어 샐러드",
        kcal: 480,
        macros: { carb: 12, protein: 34, fat: 28, sugar: 3, chol: 45 },
      },
      {
        name: "현미밥 반 공기",
        kcal: 150,
        macros: { carb: 32, protein: 3, fat: 1, sugar: 0, chol: 0 },
      },
    ],
    total: 630,
    totalMacros: { carb: 44, protein: 37, fat: 29, sugar: 3, chol: 45 },
  },
  {
    time: "07:15 PM",
    label: "저녁",
    ...
    items: [
      {
        name: "닭가슴살 구이",
        kcal: 310,
        macros: { carb: 0, protein: 47, fat: 12, sugar: 0, chol: 75 },
      },
      {
        name: "구운 고구마와 야채",
        kcal: 220,
        macros: { carb: 45, protein: 4, fat: 1, sugar: 0, chol: 0 },
      },
    ],
    total: 530,
    totalMacros: { carb: 45, protein: 46, fat: 13, sugar: 8, chol: 75 },
  },
  {
    time: "04:00 PM",
    label: "간식",
    ...
    items: [
      {
        name: "사과와 땅콩버터",
        kcal: 190,
        macros: { carb: 22, protein: 4, fat: 11, sugar: 15 },
      },
      {
        name: "단백질 쉐이크",
        kcal: 120,
        macros: { carb: 3, protein: 24, fat: 1, sugar: 1, chol: 15 },
      },
    ],
    total: 310,
    totalMacros: { carb: 25, protein: 28, fat: 12, sugar: 16, chol: 15 },
  },
];
          ...
          <div className="grid grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
              <div className="flex items-start justify-between mb-5">
                ...
                <span className="text-[11px] font-semibold uppercase tracking-wide text-purple-600 bg-purple-50 rounded-full px-3 py-1">
                  식단
                </span>
              </div>
              <p className="text-xs text-slate-400 mb-1">오늘의 섭취 kcal</p>
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
              <div className="flex items-start justify-between mb-5">
                ...
                <span className="text-[11px] font-semibold uppercase tracking-wide text-emerald-600 bg-emerald-50 rounded-full px-3 py-1">
                  운동
                </span>
              </div>
              <p className="text-xs text-slate-400 mb-1">오늘의 활동 시간</p>
              <div className="flex items-baseline gap-1">
                <span className="text-3xl font-bold text-gray-900">45</span>
                <span className="text-base text-slate-400 font-medium">분</span>
              </div>
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
              <div className="flex items-start justify-between mb-5">
                ...
                <span className="text-[11px] font-semibold uppercase tracking-wide text-blue-600 bg-blue-50 rounded-full px-3 py-1">
                  체중
                </span>
              </div>
              <p className="text-xs text-slate-400 mb-1">현재 체중 및 추세</p>
              <div className="flex items-baseline gap-1">
                <span className="text-3xl font-bold text-gray-900">72.4</span>
                <span className="text-base text-slate-400 font-medium">kg</span>
              </div>
              <p className="text-[11px] text-emerald-600 font-medium mt-1 flex items-center gap-0.5">
                <TrendingDown size={12} /> 지난주 대비 -0.8kg
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100">
              <div className="flex items-start justify-between mb-5">
                ...
                <span className="text-[11px] font-semibold uppercase tracking-wide text-sky-600 bg-sky-50 rounded-full px-3 py-1">
                  수분
                </span>
              </div>
              <p className="text-xs text-slate-400 mb-1">오늘의 수분 섭취량</p>
              <div className="flex items-baseline gap-1">
                <span className="text-3xl font-bold text-gray-900">1.6</span>
                <span className="text-base text-slate-400 font-medium">
                  / 2.5 L
                </span>
              </div>
          ...
          <div className="grid grid-cols-4 gap-4">
            {meals.map((meal, idx) => (
              ...
              >
                {/* Meal Image Header */}
                <div
                  className={`h-24 bg-gradient-to-br ${meal.color} relative p-3 flex flex-col justify-end`}
                >
                ...
                <div className="p-3.5">
                  {meal.items.map((item, i) => (
                    <div key={i} className="mb-2.5">
                      ...
                      <div className="flex flex-wrap gap-1">
                        <MacroBadge label="탄" value={item.macros.carb} />
                        <MacroBadge label="단" value={item.macros.protein} />
                        <MacroBadge label="지" value={item.macros.fat} />
                        {item.macros.sugar !== undefined && (
                          <MacroBadge label="당" value={item.macros.sugar} />
                        )}
                        {item.macros.chol !== undefined && item.macros.chol > 0 && (
                          <MacroBadge
                            label="콜"
                            value={item.macros.chol}
                            unit="mg"
                          />
                        )}
                      </div>
                  ...
                  <div className="border-t border-gray-100 pt-2 mt-2">
                    ...
                    <div className="flex flex-wrap gap-1">
                      <MacroBadge label="탄" value={meal.totalMacros.carb} />
                      <MacroBadge
                        label="단"
                        value={meal.totalMacros.protein}
                      />
                      <MacroBadge label="지" value={meal.totalMacros.fat} />
                      <MacroBadge label="당" value={meal.totalMacros.sugar} />
                      {meal.totalMacros.chol !== undefined && (
                        <MacroBadge
                          label="콜"
                          value={meal.totalMacros.chol}
                          unit="mg"
                        />
                      )}
                    </div>
