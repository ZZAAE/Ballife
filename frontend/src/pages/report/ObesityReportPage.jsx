      ...
      <main className="max-w-7xl mx-auto p-10 pb-20">
        ...
        <div className="mb-12">
          ...
          <p className="text-sm text-gray-600 leading-relaxed max-w-3xl">
            단순한 체중의 증가를 넘어, 체내에 과도한 지방 조직이 축적되어 건강에 악영향을 미치는 상태를 의미합니다.<br />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-14">
          <div className="md:col-span-2">
            <ContentCard className="h-full">
              <h3 className="text-lg font-bold mb-5 text-gray-900">비만이란?</h3>
              <div className="text-[13px] text-gray-600 leading-relaxed space-y-4">
                <p>
                  비만은 섭취하는 에너지가 소비하는 에너지보다 많아 여분의 에너지가 체지방의 형태로 몸에 과도하게 축적된 상태를 의미합니다. 단순히 체중이 많이 나가는 것을 넘어, 축적된 지방세포가 염증 물질을 분비하여 전신의 대사 기능을 저하시키고 신체적 건강을 위협하는 상태를 말합니다.
                </p>
                <p>
                  이는 단순한 미용적 문제를 넘어 대사 증후군의 핵심 원인이 되며, 적절한 관리가 이루어지지 않을 경우 당뇨, 고혈압, 심혈관 질환뿐만 아니라 근골격계 질환과 감정적인 영향까지 유발할 수 있습니다.
                </p>
              </div>
            </ContentCard>
          </div>
        ...
        <SectionHeader title="진단 기준 (Diagnosis)" subTitle="* 체질량지수(BMI) = 체중(kg) / [신장(m)]²" />
        ...
        <div className="mb-10">
          ...
          <ContentCard className="rounded-t-none border-t-0 grid grid-cols-2 gap-10 !p-8">
            <div>
              <h4 className="font-bold text-[14px] mb-4 text-gray-900">체중 감량 보조</h4>
            ...
            <div>
              <h4 className="font-bold text-[14px] mb-4 text-gray-900">지속적 유지 관리</h4>
              <ul className="text-[12px] text-gray-600 list-disc list-outside ml-4 space-y-2 leading-relaxed">
                <li>감량 후 다시 체중이 증가하는 '요요 현상'을 방지하기 위해 사용</li>
                <li>목표 체중에 도달한 후에도 꾸준한 상담과 생활 습관 모니터링을 병행합니다.</li>
              </ul>
            </div>
          </ContentCard>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
          <div className="flex flex-col gap-6">
            <CautionBox>
              <span className="block font-bold text-gray-800 mb-1">핵심당분의 위험성</span>
              탄산음료, 가당 주스 등에 함유된 단순당(액상과당)은 흡수가 매우 빨라 간에 직접적인 부담을 주며 지방간의 주요 원인이 됩니다.
            </CautionBox>
            <CautionBox>
              <span className="block font-bold text-gray-800 mb-1">야식과 대사 장애</span>
              밤늦게 먹는 음식은 에너지로 소모되지 못하고 그대로 지방으로 축적되어 수면의 질을 저하시킵니다.
            </CautionBox>
          </div>
          <div className="md:col-span-2">
            <ContentCard className="flex gap-8 !p-8 h-full items-center">
              <div className="flex-1">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-lg font-bold text-gray-900">신체 활동 요법 (Physical Activity)</h3>
                </div>
                <p className="text-[13px] text-gray-600 leading-relaxed mb-6">
                  주 150분 이상의 중강도 무산소 운동(빠르게 걷기, 수영 등)과 주 2~3회의 근력 운동을 병행하십시오.
                </p>
                <div className="flex gap-4">
                  <div className="bg-gray-100 p-4 rounded-lg flex-1">
                    <h4 className="font-bold text-[13px] mb-1.5 text-gray-900">무산소 운동</h4>
                    <p className="text-[11px] text-gray-500">심폐지내력 향상 및 체지방 감소</p>
                  </div>
                  <div className="bg-gray-100 p-4 rounded-lg flex-1">
                    <h4 className="font-bold text-[13px] mb-1.5 text-gray-900">근력 운동</h4>
                    <p className="text-[11px] text-gray-500">기초대사량 증가 및 근육 손실 예방</p>
                  </div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-[#0a5a4a] text-white p-8 rounded-2xl flex flex-col">
            ...
            <ul className="space-y-4 flex-1">
              {[
                ...
                <li key={idx} className="flex items-start gap-3 text-[13px] text-emerald-50">
            ...
            <p className="text-[11px] text-emerald-200 mt-8 leading-relaxed">
              * 무조건 굶는 것이 아니라, 질 좋은 소량 영양소를 섭취하는 것이 중요합니다.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-5">
             <div className="flex items-center gap-3 mb-1 ml-1">
              ...
              <h3 className="text-[15px] font-bold text-gray-900">약물 및 수술</h3>
            </div>
            <StepInfoCard
              number="01"
