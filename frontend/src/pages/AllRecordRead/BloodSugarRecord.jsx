          ...
          <RecordTable
            ...
            renderDesktopRow={(row, index) => (
              ...
              >
                ...
                <td
                  className={`px-6 py-3.5 text-center font-semibold ${row.type === "warning" ? "text-rose-600" : "text-slate-700"}`}
                >
                  {row.value}
                </td>
                <td className="px-6 py-3.5 text-center">
              ...
              <div key={index} className="space-y-3 px-4 py-4">
                ...
                <div className="grid grid-cols-3 gap-3 rounded-lg bg-slate-50 p-3 text-center">
                  ...
                  <div>
                    ...
                    <p
                      className={`mt-1 text-sm font-semibold ${row.type === "warning" ? "text-rose-600" : "text-slate-700"}`}
                    >
                      {row.value}
                    </p>
                  </div>
