...
const buildEditorPickerStyle = (t) => `
  ...
  .ql-snow .ql-picker.ql-font .ql-picker-item::before {
    content: '${t("richTextEditor.font.default")}';
  ...
  .ql-snow .ql-picker.ql-font .ql-picker-item[data-value="malgun-gothic"]::before {
    content: '${t("richTextEditor.font.malgunGothic")}';
  ...
  .ql-snow .ql-picker.ql-font .ql-picker-item[data-value="nanum-gothic"]::before {
    content: '${t("richTextEditor.font.nanumGothic")}';
  ...
  .ql-snow .ql-picker.ql-font .ql-picker-item[data-value="nanum-myeongjo"]::before {
    content: '${t("richTextEditor.font.nanumMyeongjo")}';
  ...
  .ql-snow .ql-picker.ql-font .ql-picker-item[data-value="gungsuh"]::before {
    content: '${t("richTextEditor.font.gungsuh")}';
...
export default function RichTextEditor({
    ...
    toolbar.addHandler("image", () => {
      ...
      input.onchange = async () => {
        ...
        if (!file.type.startsWith("image/")) {
          toast.error(t("richTextEditor.toast.imageOnly"));
          return;
        }

        if (file.size > MAX_IMAGE_SIZE) {
          toast.error(t("richTextEditor.toast.imageTooLarge"));
          return;
        }
        ...
        const uploadToast = toast.loading(t("richTextEditor.toast.uploading"));
        try {
          ...
          toast.success(t("richTextEditor.toast.imageAttached"), { id: uploadToast });
        } catch (error) {
          console.error("이미지 업로드 실패:", error);
          toast.error(t("richTextEditor.toast.uploadFailed"), { id: uploadToast });
        }
      };
  ...
  return (
    <>
      <style>{buildEditorPickerStyle(t)}</style>
      <div
        ref={hostRef}
