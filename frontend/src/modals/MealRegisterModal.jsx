  ...
  const handleFile = (file) => {
    ...
    reader.onload = (e) => {
      ...
      analysisTimerRef.current = setTimeout(() => {
        ...
        setAnalyzed(true);
        setFoodName(DUMMY_DATA[0].mealItemName);
        setChips(
          DUMMY_DATA.map((item, index) => ({
            id: index + 1,
            label: item.mealItemName,
            active: index === 0,
          }))
        );
                ...
                {hasImage && (
                  <>
                    <div className="relative w-full flex-1 overflow-hidden rounded-t-[18px]">
                      ...
                      {analyzed && (
                        <span
                          className="absolute text-[11px] font-semibold rounded-full z-[4]"
                          style={{
                            top: "12px",
                            right: "12px",
                        ...
                        <>
                          <div
                            ...
                            style={{
                              ...
                              transform: detectionTagsVisible
                                ? "translateY(0)"
                                : "translateY(-4px)",
